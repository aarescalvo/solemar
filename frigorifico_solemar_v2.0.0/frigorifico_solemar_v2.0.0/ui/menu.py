"""
Menu Principal v2.0.0
Estructura: Pesaje | Ciclo I | Ciclo II
"""
...
class MenuScreen(tk.Frame):
    ...
    def _build(self):
        ...
        for i, (titulo, desc, color, modulo) in enumerate(modulos):
            self._make_card(grid, titulo, desc, color, modulo, 0, i)
    ...
    def _make_card(self, parent, titulo, desc, color, modulo, row, col):
        outer = tk.Frame(parent, bg=T.FONDO, width=250, height=150)
        ...
        tk.Label(card, text=titulo, font=T.FONT_TITULO, bg=T.BLANCO, fg=color).pack(pady=(30, 5))
