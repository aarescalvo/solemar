...
class PesajeMenu(tk.Frame):
    ...
    def _show_main_menu(self):
        ...
        opciones = [
            ...
            ("⚙️ CONFIG", "Numeración tickets", self._show_config, T.GRIS_OSCURO),
        ]
    ...
    def _show_config(self):
        self._clear_current()
        from ui.pesaje_config import PesajeConfig
        PesajeConfig(self._current, self._show_main_menu).pack(expand=True, fill="both")
